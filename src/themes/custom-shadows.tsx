...
export default function CustomShadows(palette: ShadowPalette) {
  const shadowColor = palette.text.primary;
  const primaryColor = palette.primary.main;

  return {
    button: `0px 0.711px 1.422px 0px ${withAlpha(shadowColor, 0.05)}`,
    section: `0px 4px 16px 0px ${withAlpha(shadowColor, 0.10)}, 0px 0px 2px 0px ${withAlpha(shadowColor, 0.06)}`,
