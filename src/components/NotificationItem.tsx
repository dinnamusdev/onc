...
// @types
import { NotificationItemProps } from '@/types/notificationItem';

/***************************  NOTIFICATION - LIST  ***************************/

export default function NotificationItem({ avatar, badgeAvatar, title, subTitle, dateTime, isSeen = false }: NotificationItemProps) {
